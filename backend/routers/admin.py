...
@router.get("/stats/bookings", response_model=BookingStatsResponse)
async def get_booking_stats(
    ...
    try:
        ...
        bookings_today = sum(
            ...
            if booking.created_at >= today_start
        )
        ...
        bookings_this_week = sum(
            1 for booking in bookings 
            if booking.created_at >= one_week_ago
        )
...
async def get_all_bookings(
    ...
    try:
        # Get all bookings with user data
